...
{
public:
	uint8                                        Pad_187[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_188[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_18A[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_18B[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               Shear;                                             // 0x318(0x90)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_18C[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
