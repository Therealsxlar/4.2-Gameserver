...
{
	static auto Func = Class->GetFunction("ItemInspectionItemExtraDetailsHostPanel_C", "Construct");

	Params::UItemInspectionItemExtraDetailsHostPanel_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("ItemInspectionItemExtraDetailsHostPanel_C", "PreConstruct");
